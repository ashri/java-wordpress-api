...
public class XmlRpcBridgeTest {
	...
	public void testGetCategories() throws XmlRpcException {
		...
		Assert.assertNotNull(ret);
		// saveObject(ret,
		// "./src/test/resources/data/categories-object.stream");
	}
	...
	/*
	 * private void saveObject(Object o, String filename) throws IOException { ObjectOutputStream out = new
	 * ObjectOutputStream(new FileOutputStream(filename)); out.writeObject(o); out.flush(); out.close(); }
	 */
